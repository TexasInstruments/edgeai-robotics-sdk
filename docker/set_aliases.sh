...
alias setup_cameras="/opt/edgeai-gst-apps/scripts/setup_cameras.sh"
...
alias bag_6d="ros2 launch ti_vision_cnn bag_6dpose_cnn_launch.py"
alias bag_vl="ros2 launch ti_vl bag_visloc_launch.py"
alias bag_3d="ros2 launch ti_objdet_range bag_objdet_range_launch.py"
...
alias gscam_6d="ros2 launch ti_vision_cnn gscam_6dpose_cnn_launch.py cam_id:=\$CAM_ID"
...
alias zed_3d="ros2 launch ti_objdet_range zed_objdet_range_launch.py cam_id:=\$CAM_ID zed_sn:=\$ZED_SN"
...
alias imx219_cap_fhd="ros2 launch gscam2 v4l_imx219_launch.py cam_id:=\$CAM_ID subdev_id:=\$SUBDEV_ID width:=1920 height:=1080"
...
alias viz_gscam_fhd="ros2 launch ti_viz_nodes gscam_nv12_launch.py width:=1920 height:=1080"
...
alias viz_6d="ros2 launch ti_viz_nodes rviz_6dpose_cnn_launch.py width:=1280 height:=960"
...
alias viz_3d="ros2 launch ti_viz_nodes rviz_objdet_range_launch.py"

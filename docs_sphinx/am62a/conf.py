...
project = 'Robotics SDK for AM62A'
...
exclude_patterns = [
    ...
    'source/docs/performance_report_j7x.md',
    'source/docs/april_tag.md',
    'source/docs/realsense_driver_node.md',
    'source/ros2/nodes/ti_objdet_range/README.md',
    'source/ros2/nodes/ti_vision_cnn/README_6D_pose.md',
]
...
def setup(app):
    ...
    # app.add_config_value('device', 'am62a', 'env')

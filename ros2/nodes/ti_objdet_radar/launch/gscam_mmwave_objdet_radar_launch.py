...
def generate_launch_description():
    ...
    # include gscam_mmwave_launch.py
    # ros2 launch ti_objdet_radar gscam_mmwave_launch.py
    gscam_mmwave_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(get_launch_file('ti_objdet_radar', 'gscam_mmwave_launch.py')),
    )
